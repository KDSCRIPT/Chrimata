...
COMPLEX_WORKFLOW_EXAMPLES = {
    ...
    Workflow: Complete Content Creation & Marketing Pipeline
    
    Business Context: Digital marketing agency serving enterprise clients
    Monthly Volume: 1000 blog posts, 500 social media posts, 200 video scripts, 100 email campaigns
    Budget: $15,000/month
    Quality Requirements: Enterprise-grade content, brand consistency, SEO optimization
    Timeline: 48-hour turnaround for most content
    ...
    2. Multi-format Content Creation
       - Long-form blog articles (2000-4000 words)
    ...
    3. Visual Content Generation
       - Blog header images and infographics
       - Social media graphics and carousels
       - Thumbnail designs for videos
       - Email newsletter layouts
       
    4. Content Optimization & Enhancement
    ...
    5. Multi-language Localization
       - Translation to 5 languages (Spanish, French, German, Japanese, Portuguese)
    ...
    6. Quality Assurance & Fact-checking
       ...
       - Legal content review for regulated industries
       
    7. Content Scheduling & Distribution
    ...
    - <2 hour average processing time per piece
    - 40% improvement in engagement rates
    - 60% reduction in manual editing required
    """,
    
    "ecommerce_automation": """
    Workflow: Complete E-commerce Automation System
    
    Business Context: Multi-platform e-commerce business with 50,000+ products
    Monthly Volume: 10,000 new product listings, 500,000 customer interactions, 5,000 reviews
    Budget: $25,000/month
    Integration: Shopify, Amazon, eBay, social media platforms, email systems
    
    Workflow Steps:
    1. Product Data Intelligence
       - Automated product research and trend analysis
    ...
    2. Content Generation at Scale
       ...
       - Product comparison charts and guides
       
    3. Visual Content Creation
       - Product image enhancement and background removal
       - Lifestyle and context images generation
       - Infographic creation for complex products
       - Video script writing for product demos
    ...
    6. Pricing and Inventory Optimization
    ...
    - <500ms response time for customer queries
    ...
    Workflow: Advanced Research & Development Pipeline
    
    Business Context: Pharmaceutical research company developing new treatments
    Monthly Volume: 1000+ research papers analysis, 500 patent reviews, 200 clinical trial reports
    Budget: $40,000/month
    Compliance: FDA regulations, GxP standards, data integrity requirements
    
    Workflow Steps:
    1. Literature Review and Analysis
       - Automated research paper summarization
       - Key findings extraction and categorization
       - Methodology analysis and comparison
       - Citation network analysis
       
    2. Patent Intelligence
       - Patent landscape analysis
       - Prior art searching and comparison
       - Patent filing strategy optimization
    ...
    5. Regulatory Documentation
       ...
       - Protocol writing and optimization
    ...
    - Regulatory submission quality standards
    """
}
